/* File Login.tsx
 * Contains login components for entering username/password
 */
 ...
 * Code here is mostly generated from
...
export function GoogleLoginButton(props: GoogleLoginButtonProps): React.JSX.Element {

	return <button className="gsi-material-button" onClick={props.onclick}>
